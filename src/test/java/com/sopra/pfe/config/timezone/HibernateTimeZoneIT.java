package com.sopra.pfe.config.timezone;

import static java.lang.String.format;
import static org.assertj.core.api.Assertions.assertThat;

import com.sopra.pfe.IntegrationTest;
import com.sopra.pfe.repository.timezone.DateTimeWrapper;
import com.sopra.pfe.repository.timezone.DateTimeWrapperRepository;
import java.time.*;
...
class HibernateTimeZoneIT {
    ...
    private String generateSqlRequest(String fieldName, long id) {
        return format("SELECT %s FROM sopra_date_time_wrapper where id=%d", fieldName, id);
    }
